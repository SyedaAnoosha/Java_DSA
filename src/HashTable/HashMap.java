...
public class HashMap {
    static private class ListNode {
        // Keys that have the same hash code are placed together in a linked list.  This private nested class is used
        // internally to implement linked lists.  A ListNode holds a (key,value) pair.
        Object key;
        Object value;
    ...
    private void resize() {
        ...
        for (int i = 0; i < table.length; i++) {
            // Move all the nodes in linked list number i into the new table.  No new ListNodes are
            // created.  The existing ListNode for each key/value pair is moved to the newtable.
            // This is done by changing the "next" pointer in the node and by making a pointer in the
            ...
            while (list != null) {
                ...
                /*
                 The is the next node in the list.
